...
class PdfGenerator {
  Future<List<int>> generateApplicationPdf(
      ...
      pw.MultiPage(
        ...
        build: (ctx) => [
          ...
          _buildSection('Personal Information', [
            ...
            _field(
              'Date of Birth',
              profile.personal.dateOfBirth != null
                  ? dateFormat.format(profile.personal.dateOfBirth!)
                  : '',
            ),
          ...
          _buildSection('Results', [
            _field(
              'Matric Year',
              profile.results.matricYear > 0
                  ? profile.results.matricYear.toString()
                  : '',
            ),
            ...
            _field(
              ...
              profile.results.schoolLeavingCertificate,
            ),
          ], theme),
          _buildSection('Qualification', [
            _field(
              'Academic Year',
              profile.qualification.academicYear > 0
                  ? profile.qualification.academicYear.toString()
                  : '',
            ),
            _field(
              'Faculty',
              profile.qualification.choices.isNotEmpty
                  ? profile.qualification.choices.first.faculty
                  : '',
            ),
            _field(
              'Programme',
              profile.qualification.choices.isNotEmpty
                  ? profile.qualification.choices.first.programme
                  : '',
            ),
            _field(
              'Application Period',
              profile.qualification.applicationPeriod,
            ),

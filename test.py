...
# Paste your autofill_script.dart code between the triple quotes below
your_code = """
...
(function() {
  ...
  var fieldMap = {
    ...
    'initials':          ['initials'],
    'gender':            ['gender','sex'],
    'idNumber':          ['idnumber','id number','identity number','national id','sa id','passport number','rsaid','rsaid'],
...
completion = client.chat.completions.create(
    ...
    messages=[
        {"role": "user", "content": f"""
I'm trying to autofill a Venda university application form.
The script fills oapSurname and oapInitials, but misses:
- oapNames
- oapIdNumber
- oapEmail
- oapCellNo

Here is my code:AQ.Ab8RN6IVwXpKVFMs1j_VL_cUqtIOZK93baJdG7292qQCvh31PA
